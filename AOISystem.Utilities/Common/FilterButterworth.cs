...
namespace AOISystem.Utilities.Common
{
    public class FilterButterworth
    {
        ...
        {
            if (this.outputHistory[0] == 0 && this.outputHistory[1] == 0 && this.outputHistory[2] == 0)
            {
                this.outputHistory[0] = newInput;
                this.outputHistory[1] = newInput;
                this.outputHistory[2] = newInput;
            }
