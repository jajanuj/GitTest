...
{
    public partial class CEtherCATDO7062Form : Form
    {
        private CEtherCATDO7062 io;
        private bool isInitFinished;

        public CEtherCATDO7062Form(CEtherCATDO7062 io)
        {
            InitializeComponent();
            this.io = io;
        }
        ...
        {
            ushort bitNum = Convert.ToByte(((LedRectangle)sender).Tag);

            bool ret = io.SetOutput(bitNum, !((LedRectangle)sender).On);
            if (ret == false)
