...
namespace AOISystem.Utilities.Modules.Syntek.L132.Library
{
    internal class CPCI_L122
    {
        ...
        [DllImport("PCI_L122C.dll" , EntryPoint = "_l122_int_link")]
        ...
        [DllImport("PCI_L122C.dll" , EntryPoint = "_l122_int_link_with_flag")]
