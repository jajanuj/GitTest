...
{
    public partial class L132A180ADCForm : Form
    {
        private L132A180ADC adc;
        private bool initFinished;

        private L132A180ADCForm()
        {
            InitializeComponent();
        }

        public L132A180ADCForm(L132A180ADC adc)
        {
            InitializeComponent();
            this.adc = adc;
        }
        ...
        private void L132A180ADCForm_Load(object sender , EventArgs e)
        {
            controlsInit();
        ...
        private void L132A180ADCForm_FormClosed(object sender , FormClosedEventArgs e)
        {
        ...
        private void lbtnEnable_MouseClick(object sender , MouseEventArgs e)
        {
            ...
            foreach (PropertyInfo p in pi)
            {
                ...
                {
                    byte val = Convert.ToByte(!((LedButton)sender).Active);
        ...
        private void timer1_Tick(object sender , EventArgs e)
        {
            ...
            lbtnCH0.Active = Convert.ToBoolean(adc.AdcPara.EnableCH0);
            lbtnCH1.Active = Convert.ToBoolean(adc.AdcPara.EnableCH1);
            lbtnCH2.Active = Convert.ToBoolean(adc.AdcPara.EnableCH2);
            lbtnCH3.Active = Convert.ToBoolean(adc.AdcPara.EnableCH3);
            lbtnCH4.Active = Convert.ToBoolean(adc.AdcPara.EnableCH4);
            lbtnCH5.Active = Convert.ToBoolean(adc.AdcPara.EnableCH5);
            lbtnCH6.Active = Convert.ToBoolean(adc.AdcPara.EnableCH6);
            lbtnCH7.Active = Convert.ToBoolean(adc.AdcPara.EnableCH7);
        }
