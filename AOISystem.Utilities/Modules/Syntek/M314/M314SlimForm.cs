...
namespace AOISystem.Utilities.Modules.Syntek.M314
{
    ...
    internal partial class M314SlimForm : Form
    {
        ...
        private M314SlimForm()
        {
            InitializeComponent();
        }

        public M314SlimForm(M314 axis , Language language)
        {
            InitializeComponent();
        ...
        private void M314SlimForm_FormClosing(object sender, FormClosingEventArgs e)
        {
