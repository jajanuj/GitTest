...
namespace AOISystem.Utilities.Modules.Syntek.L122.SlaveModules.Motion
{
    ...
    internal partial class L122M1X1Form : Form
    {
        ...
        public L122M1X1Form(L122M1X1 axis)
        {
            InitializeComponent();
            this.Text = axis.DeviceName;
            this.axis = axis;
        ...
        private void parameterInitial()
        {
            ...
            //cmbEL.SelectedIndex = Convert.ToInt16(axis.AxisPara.lo);
        ...
        private void L122M1X1Form_Load(object sender , EventArgs e)
        {
            parameterInitial();
        ...
        {
            axis.Offset(Convert.ToDouble(ntxbPosition1.Text) , SpeedMode.Manual);
        }
