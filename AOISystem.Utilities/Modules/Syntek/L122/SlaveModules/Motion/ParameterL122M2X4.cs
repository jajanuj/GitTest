...
{
    [Serializable]
    public class ParameterL122M2X4 : ParameterINI
    {
        #region field
        ...
        public AxisNo AxisNo { get { return axisNo; } set { axisNo = value; WriteAndNotify("AxisNo"); } }
        ...
        [Browsable(false)]
        public bool LogicORG { get { return logicORG; } 
            set 
            { 
                logicORG = value; 
                WriteAndNotify("LogicORG"); 
            } 
        }
