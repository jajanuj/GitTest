    ...
    public class IniFile
    {
        ...
        public IniFile(string path)
        {
            ...
            if (string.IsNullOrEmpty(extension))
            {
                ...
                _path = GetIniFilePath(folderPath, fileName);
            }
            else
            {
        ...
        /// a null reference  (Nothing in VB)
        /// </exception>
        public byte GetByte(string sectionName,
                            string keyName,
                            byte defaultValue)
        {
        ...
        public byte GetByte(string sectionName, string keyName)
        {
            return GetByte(sectionName, keyName, 0);
        }
        ...
        /// The write failed.
        /// </exception>
        public void WriteValue(string sectionName, string keyName, byte value)
        {
        ...
        public static string GetIniFilePath(string folderPath, string fileName)
        {
            string path = string.Empty;
            if (folderPath[1] != System.IO.Path.VolumeSeparatorChar)
            {
                path = string.Format(@"{0}\{1}", System.Windows.Forms.Application.StartupPath, folderPath);
            }
            else
            {
                path = folderPath;
            ...
            path = string.Format(@"{0}{1}{2}", path, fileName, fileName.Contains(".ini") ? string.Empty : ".ini");
            return path;
        }
